...
### Activating HTTPS
After configuring and adding all domain aliases, it is advicable to enable HTTPS on your Netlify site. Just enable the automatic TLS certificates for it in domain settings of your site (Domain management -> HTTPS).
